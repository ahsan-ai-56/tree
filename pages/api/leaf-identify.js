    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are an expert botanist specializing in leaf identification. Always respond with valid JSON only. No markdown, no backticks, no thinking tags, no extra text. Only pure JSON.',
          },
          {
            role: 'user',
            content: [

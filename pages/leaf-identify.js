export default async function handler(req, res) {
  ...
  try {
          ...
          },
          {
            ...
            content: [
              ...
              },
              {
                type: 'text',
                text:
                  'Analyze this leaf image carefully. Examine the shape, margin, venation, texture, ' +
                  'color, and any other visible features to identify the tree species. ' +
    ...
    console.error('Leaf identification error:', err.message);
